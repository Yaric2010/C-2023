...
int main()
{
    ...
    btn[0] = {10, "Вид одежды", "T-Shirt", 1};
    btn[1] = {158, "Напитки", "drinks", 2};
    btn[2] = {158 + 148, "Головные уборы", "head_wear", 3};

    picture menu_pic[50];
    menu_pic[0] = {930,  60,  141, 165};
    menu_pic[1] = {1078, 60,  141, 165};
    menu_pic[2] = {930, 255,  141, 165};
    menu_pic[3] = {930,  60,  141, 165};
    menu_pic[4] = {1078, 60,  141, 165};
    menu_pic[5] = {930,  255, 141, 165};
    menu_pic[6] = {1078, 255, 141, 165};
    menu_pic[7] = {930,  450, 141, 165};
    menu_pic[8] = {1078, 450, 141, 165};
    menu_pic[9] = {930,  60,  141, 165};
    ...
    for(int i=0; i<count_pic; i++)
    {
      ...
      /*  if(menu_pic[i].category == "head_wear" || menu_pic[i].category == "drinks")
        ...
        {
             menu_pic[i].w_scr = menu_pic[i].w / 1.5;
             menu_pic[i].h_scr = menu_pic[i].h / 1.5;
        }    */
    }
